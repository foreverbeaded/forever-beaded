...
function addWing(vertices, side, origin, yaw, scale, flap, light) {
  const black = [0.018 * light, 0.014 * light, 0.01 * light, 0.72];
  const orange = [0.95 * light, 0.39 * light, 0.09 * light, 0.82];
  const amber = [1.0 * light, 0.6 * light, 0.2 * light, 0.76];
  const cream = [1.0 * light, 0.88 * light, 0.68 * light, 0.58];
...
function addButterflyGeometry(vertices, butterfly, now, opening) {
  ...
  const scale = butterfly.plan.scale * origin.scale;
