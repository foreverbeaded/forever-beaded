...
const products = [
  {"id":46,"slug":"fall-leaves-keychain","name":"Fall Leaves Keychain","price":25,"category":"Fall Collection","image":"etsy/images-branded/fall-leaves-keychain-owner-approved-master.jpg","createUrl":"create.html?design=custom-idea&idea=Fall%20Leaves%20Keychain#homeDesignBuilder","description":"A handmade beaded autumn leaf keychain in red, orange, yellow and brown."},
  { id: 1, slug: "macaw", productId: "macaw", name: "Macaw", price: 47, category: "Birds", image: "etsy/images-branded/macaw-owner-approved-master.jpg", description: "A vibrant Sunset Macaw inspired beaded design for bird lovers." },
  { id: 2, slug: "natalies-butterfly", name: "Natalie's Butterfly", price: 25, category: "Butterfly", image: "etsy/images-branded/natalies-butterfly-owner-approved-master.jpg", description: "Inspired by Natalie's love for nature, this butterfly design is a delightful addition to any collection." },
  { id: 3, slug: "butterfly", productId: "butterfly", name: "Butterfly", price: 20, category: "Butterfly", collections: ["Butterfly", "Mother's Day"], image: "etsy/images-branded/butterfly-owner-approved-master.jpg", description: "A handmade beaded butterfly design." },
  { id: 4, slug: "butterfly-collection", name: "Butterflies Collection", price: 22, category: "Butterfly", image: "etsy/images-branded/butterflies-collection-approved-master.jpg", description: "A colourful collection of handmade butterfly designs." },
  { id: 5, slug: "flower-braided", name: "Flower Braided", price: 18, category: "Flower", image: "etsy/images-branded/flower-owner-approved-master.jpg", description: "A delicate braided flower design." },
  ...
  { id: 134, slug: "lion", productId: "lion", name: "Lion", price: 25, category: "Animals", collections: ["Safari"], image: "etsy/images-branded/lion-safari-owner-approved.jpg", description: "A warm orange-and-yellow handmade beaded lion keychain." },
  { id: 135, slug: "zebra", productId: "zebra", name: "Zebra", price: 25, category: "Animals", collections: ["Safari"], image: "etsy/images-branded/zebra-safari-owner-approved.jpg", description: "A classic black-and-white handmade beaded zebra keychain." },
  ...
  { id: 48, slug: "baseball", name: "Baseball", price: 20, category: "Sports", image: "images/sports/baseball.jpg", description: "A personalized flat pony-bead baseball keychain." },
  { id: 49, slug: "best-friends-forever-bracelet", name: "Best Friends Forever Bracelet", price: 15, category: "Accessories", image: "images/accessories/best-friends-forever-bracelet.jpg", description: "A personalized friendship bracelet made with any two names and favourite colours." },
  { id: 50, slug: "unicorn-dreams-bracelet", name: "Unicorn Dreams Bracelet", price: 15, category: "Accessories", image: "images/accessories/unicorn-dreams-bracelet.jpg", description: "A personalized magical bracelet with pearly beads and a heart detail." },
  { id: 51, slug: "mermaid-wishes-bracelet", name: "Mermaid Wishes Bracelet", price: 15, category: "Accessories", image: "images/accessories/mermaid-wishes-bracelet.jpg", description: "A personalized ocean-coloured bracelet with pearly beads and a heart detail." },
  { id: 52, slug: "sweetheart-bracelet", name: "Sweetheart Bracelet", price: 15, category: "Accessories", image: "images/accessories/sweetheart-bracelet.jpg", description: "A personalized heart-name bracelet in bright, playful colours." },
  ...
  { id: 20, slug: "crab", productId: "crab", name: "Crab", price: 25, category: "Sandy Beaches", image: "etsy/images-branded/crab-approved-master.jpg", description: "A playful handmade crab design with coastal charm." },
  { id: 21, slug: "penguin", productId: "penguin", name: "Penguin", price: 20, category: "Ocean Animals", image: "etsy/images-branded/penguin-etsy-branded.jpg", description: "A handmade penguin from the Arctic side of the ocean collection." },
  { id: 22, slug: "whale", productId: "whale", name: "Whale", price: 25, category: "Ocean Animals", image: "etsy/images-branded/whale-approved-master.jpg", description: "A calm handmade whale design with deep-ocean charm." },
  { id: 23, slug: "jellyfish", productId: "jellyfish", name: "Jellyfish", price: 25, category: "Ocean Animals", image: "etsy/images-branded/jellyfish-approved-master.jpg", description: "A graceful handmade jellyfish inspired by drifting sea light." },
  { id: 24, slug: "lobster", productId: "lobster", name: "Lobster", price: 25, category: "Ocean Animals", image: "etsy/images-branded/lobster-owner-approved-master.jpg", description: "A bright handmade lobster design with coastal character." },
  { id: 25, slug: "shark", productId: "shark", name: "Shark", price: 25, category: "Ocean Animals", image: "etsy/images-branded/shark-approved-master.jpg", description: "A bold handmade shark design." },
  { id: 17, slug: "pencil", name: "Colouring Pencil", price: 20, category: "Back to School", image: "etsy/images-branded/colouring-pencil-owner-approved-master.jpg", description: "A handmade colouring pencil keychain." },
  { id: 19, slug: "faith-cross", productId: "faith-cross", name: "Faith Cross", price: 20, category: "Faith", image: "etsy/images-branded/faith-cross-owner-approved-master.jpg", description: "A handmade purple-and-turquoise cross spelling FAITH." },
  { id: 33, slug: "joy-cross", productId: "joy-cross", name: "Joy Cross", price: 20, category: "Faith", image: "etsy/images-branded/joy-cross-owner-approved-master.jpg", description: "A handmade blue-and-purple cross spelling JOY." },
  { id: 34, slug: "peace-cross", productId: "peace-cross", name: "Peace Cross", price: 20, category: "Faith", image: "etsy/images-branded/peace-cross-owner-approved-master-v2.png", description: "A handmade pink-and-white cross spelling PEACE." },
  { id: 26, slug: "ice-cream-keychain", productId: "ice-cream-keychain", name: "Ice Cream Keychain", price: 25, category: "Sweet Treats", image: "etsy/images-branded/ice-cream-keychain-etsy-branded.jpg", description: "A handmade beaded ice cream keychain." },
  ...
  { id: 40, slug: "owl", name: "Owl", price: 25, category: "Birds", collections: ["Birds", "Fall Collection"], image: "etsy/images-branded/owl-etsy-branded.jpg", createUrl: "create.html?design=custom-idea&idea=Owl#homeDesignBuilder", description: "A personalized handmade owl keychain." },
...
function normalizeStoredCartItem(item) {
  ...
  if (item.isCustom) {
    ...
    return {
      ...
      price,
      image: String(item.image || "etsy/images-branded/custom-idea-etsy-branded.jpg"),
...
function addCustomToCart() {
  ...
  const customItem = {
    ...
    name: `Custom ${design}`,
    price,
    image: "etsy/images-branded/custom-idea-etsy-branded.jpg",
